  ...
  return (
    <section id="about" className="about">
      <div className="container">
        <h2>About Us</h2>
        <p className="intro">
          At <span className="highlight-bold">Math4Less</span>, we’re passionate
        ...
        <p className="intro">
          ...
          online learning options, <span className="highlight-bold">Math4Less</span> is here to accommodate your needs. We
          pride ourselves on fostering a positive and encouraging learning
          environment that inspires curiosity, critical thinking, and a genuine
          love for math.
        </p>
        <p className="closing">
          Join <span className="highlight-bold">Math4Less</span> today and
